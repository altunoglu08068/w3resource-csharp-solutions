...
namespace AbsoluteDifference
{
    class Program
    {
        ...
        // Büyüklük durumuna göre mutlak farkı veya mutlak farkın iki katını döndüren fonksiyonum.
        static int CalculateAbsoluteDifference(int num1, int num2) =>
            (num1 > num2) ? Math.Abs(num1 - num2) * 2 : Math.Abs(num1 - num2);

        static void PrintHeader(int num1, int num2, int result)
        {
            Console.WriteLine("\n========================================");
            Console.WriteLine("      Absolute Difference Calculator     ");
            Console.WriteLine("========================================\n");
            ...
            string line3Prefix = (num1 > num2)
                ? $"Result (Double)\t: |{num1} - {num2}| x 2 = "
                : $"Result (Normal)\t: |{num1} - {num2}| = ";
        ...
        static void Main(string[] args)
        {
            ...
            int result = CalculateAbsoluteDifference(num1, num2);
